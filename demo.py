...
#Using files credentials.py and configuration.py for user dependant variables.
...
'''
Uncomment the result line below to allow the demo script to purchase the first number returned by the querey above.
